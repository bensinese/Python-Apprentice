...
guest_days = input("how many days are you staying")
def check_in(checked_in_rooms, roomnumber,roomdays,guestname):
    checked_in_rooms[roomnumber] = roomdays, guestname

check_in(checked_in_rooms,rooms[6],guest_days,guest_name)
print(checked_in_rooms)